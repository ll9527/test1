// pages/admin/adminProductDetails/adminProductDetails.js
Page({
  ...
  onLoad(res) {
    ...
    // })
    wx.request({
      url: getApp().url + '/product/selectAdminProDetail',
      data: {
        productid: res.productid
      },
  ...
  goPay(res) {
    ...
    wx.getStorage({
      ...
      success: function (res) {
        ...
        var url = '/pages/admin/order/order?userid=' + res.data + "&versionName=" + that.data.classify[that.data.radioId].versionName
          + "&version1Name=" + version1Name + "&count=" + 1
